...
This density plot shows us the distribution shapes of the transformed logarithm GDP Dollar values. This provides us with an easier view of our data by removing skewness from outliers. We easily see that the High Income:OECD group contains the highest GDP dollar values, since their density curve is centered at a higher log(USDollar) value.